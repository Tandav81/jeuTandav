...
@export var resource_name2 = "Peau"   # 2e drop (laisser vide pour désactiver)
@export var quantity2 = 1
...
func die():
	...
	if resource_name2 != "":
		Inventory.add_item(resource_name2, quantity2)
	print("Ressource obtenue : ", resource_name, " x", quantity,
		  (" + " + resource_name2 + " x" + str(quantity2)) if resource_name2 != "" else "")
